...
$('.modal__closeee').on('click', function(){
...
$('.infomsg').on('click', function(){
  $('.overla').toggleClass('overla_active');
  $('.mod').toggleClass('mod_active');
});
$('.modal__clos').on('click', function(){
  $('.overla').toggleClass('overla_active');
  $('.mod').toggleClass('mod_active'); 
});
$('.call').on('click', function(){
  $('.overlayyyy').toggleClass('overlayyyy_active');
  $('.modaaaa').toggleClass('modaaaa_active');
});
$('.modal__closeeee').on('click', function(){
  $('.overlayyyy').toggleClass('overlayyyy_active');
  $('.modaaaa').toggleClass('modaaaa_active'); 
});
...
$(function() {
  ...
  $('.minibtn, .minibtnn, .minibtnnn').click(function() {
